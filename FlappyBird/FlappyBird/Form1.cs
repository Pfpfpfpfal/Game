...
namespace FlappyBird
{
    ...
    {
        Player bird;//объявление переменных
        TheWall wall1;
        TheWall wall2;
        float gravity;
        public Form1()
        ...
        private void OnPaint(object sender, PaintEventArgs e)//отрисовка спрайтов
        {
            Graphics graphics = e.Graphics;

            graphics.DrawImage(bird.birdImg, bird.x, bird.y, bird.size, bird.size);//рисование птички
